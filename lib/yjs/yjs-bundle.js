  ...
  "node_modules/codemirror/lib/codemirror.js"(exports, module) {
    (function(global2, factory) {
      ...
      function restoreSelection(snapshot2) {
        if (!snapshot2 || !snapshot2.activeElt || snapshot2.activeElt == activeElt(rootNode(snapshot2.activeElt))) {
          return;
        }
        snapshot2.activeElt.focus();
        if (!/^(INPUT|TEXTAREA)$/.test(snapshot2.activeElt.nodeName) && snapshot2.anchorNode && contains(document.body, snapshot2.anchorNode) && contains(document.body, snapshot2.focusNode)) {
          var doc3 = snapshot2.activeElt.ownerDocument;
          var sel = doc3.defaultView.getSelection(), range2 = doc3.createRange();
          range2.setEnd(snapshot2.anchorNode, snapshot2.anchorOffset);
          range2.collapse(false);
          sel.removeAllRanges();
          sel.addRange(range2);
          sel.extend(snapshot2.focusNode, snapshot2.focusOffset);
        }
      }
...
var equalFlat2 = (a, b) => a === b || size(a) === size(b) && every2(a, (val, key) => (val !== void 0 || hasProperty(b, key)) && equals(b[key], val));
