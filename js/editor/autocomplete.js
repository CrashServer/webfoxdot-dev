...
const GLOBALS = [
    ...
    'ascii_gen(','audiviz(','audioviz(','theme(','uisize(','seed(','scenes()','record(','recall(','store(','sample(','audioin(','forget(','panel(','compo_base(','troop(','codesource(','midimap()','midicc(','midiprog(','midinrpn(','troopclock(','troopnudge(','rgbshift(','grain(','solarize(','threshold(','tint(','halftone(','language(','attack(','modular()','panic()',
