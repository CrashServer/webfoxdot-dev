...
const GLOBALS = [
    ...
    'ascii_gen(','audiviz(','audioviz(','theme(','uisize(','seed(','scenes()','record(','recall(','panel(','compo_base(','troop(','codesource(','troopclock(','troopnudge(','rgbshift(','grain(','solarize(','threshold(','tint(','halftone(','language(','attack(','modular()','panic()',
