...
const CHANGELOG = [
    { v: 'beta01', title: 'Beta! · 3 new themes · offline PWA · zoomable galaxy', items: [
        'Mobile (Tier 1) — on a phone the editor now goes full-width and the side panel (Clock/Players/Composition/Settings) becomes a slide-up DRAWER: tap ☰ panel to open it, tap the scrim to close. Touch devices get fatter tap targets and a slightly larger editor font. The audio engine also caps its sample-buffer pool at 64MB on low-RAM/phone devices (the full 128MB could OOM a mobile tab), and resumes the AudioContext on tab-refocus + the next tap — so sound comes back after backgrounding or a screen lock. (A browse-and-play mobile client; touch performance controls + on-screen editing keys come next.)',
