...
const CHANGELOG = [
    { v: 'beta10', title: 'Visuals — a clean 2-channel mixer', items: [
        ...
        'Under the hood it\'s modular, not a monolith: a tiny engine (grid · compositor · palette · blends · draw · postfx) plus one file per scene behind a registry — adding a scene is a new file + one import, and a WebGL backend later only touches the draw step. Ships with plasma · tunnel · wave · rain · spiral · cells · starfield · nebula · moire · bars · grid · ripple, all audio-reactive.',
    ] },
