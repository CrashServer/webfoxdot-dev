...
const CHANGELOG = [
    { v: 'dev01', title: 'Desktop UI · virtual piano · scratch buffers · MIDI export', items: [
...
#@end(16)`)}
    ...
    const vAll = section('Visuals — scenes, FX & the mixer', `
        ...
        ${note('The whole catalogue as one runnable <code>#@</code> set — all <b>49 scenes</b>, all <b>17 FX</b> and all 7 blends. Boot audio, run a video player to open the visuals window, put the cursor on <code>#@intro</code> and Ctrl+Enter — it auto-advances through every scene family, each part chaining different FX.')}
