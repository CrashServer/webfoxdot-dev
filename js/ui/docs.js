...
'chaos() and the son() jam bot now generate far more interesting players: role-aware degrees (arps via arp/PArp/PGrowArp, chords via PChord/PRoman/PCircle, melody()[:n], PContour, PRange), musical durations (PDur, PDur(<3,5>,8), PGroove), TimeVar filter sweeps (linvar/sinvar), a wide FX palette (bpf/eq3/spin/pong/chop/rgate…) and chained live transforms (.every/.sometimes/.unison/.human). Drums use Euclidean and subdivided/layered patterns.',
