...
const CHANGELOG = [
    { v: 'alpha28', title: 'Pop-out visuals (clift)', items: [
        ...
        'Autocomplete is now a nested flyout menu: the category headers (synths · patterns · params · fx · …) are rows you unfold to the RIGHT — hover or press → to open a submenu, ← to go back, ↵/Tab to pick, Esc to close. Param and FX names show clean (no trailing = or …) while still inserting the full amp= / lpf=2000, … form.',
