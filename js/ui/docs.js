...
export const PATTERNS = [
    ...
    { name: 'PContour(shape, n, range)', desc: 'Melodic contour — n scale degrees in [0,range] following shape. shape: a NAME (up/down/arch/valley/wave), a NUMBER (index into those), or an ARRAY of control points to draw your own contour, e.g. PContour([0,7,2,5], 8)' },
