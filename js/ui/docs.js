...
const CHANGELOG = [
    { v: 'alpha31', title: 'Share by link · go live from a composition', items: [
        ...
        'For server operators: a live monitor dashboard at /monitor on the collab server — real-time CPU/RSS/heap, active multiplayer sessions and solo players, throughput, and a live feed of what everyone is evaluating (session AND solo evals). Streams over SSE; localhost-only unless collab.metricsPublic is set.',
    ] },
