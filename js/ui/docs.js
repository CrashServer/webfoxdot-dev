...
const CHANGELOG = [
    { v: 'beta11', title: 'hiss (unified noise) · 5 new voices + tape/bitcrush FX · UX fixes', items: [
        ...
        'The toolbar 🎛 modular button is hidden for the moment (still early/experimental) — the modular synth builder is still fully there, just reachable by evaluating modular() instead, same pattern as the hidden ▦ visuals button and openVisuals().',
