// ── Mandelbulb layer ──────────────────────────────────────────────────────
// Ported from the WebGPU version's layer_mandelbulb.wgsl (see
// webgl/glMandelbulb.js for the one behavior change). 4th layer on the
// shared WebGL2 context.
import * as gl from "../webgl/glMandelbulb.js";

export const mandelbulbParams = () => ({
    power:      { base: 8,   min: 2,   max: 12,  mod: { source: "" } },
    spin:       { base: 0.2, min: -2,  max: 2,   mod: { source: "" } },
    iters:      { base: 10,  min: 4,   max: 16,  mod: { source: "" } },
    camDist:    { base: 2.6, min: 1.5, max: 5,   mod: { source: "" } },
    hueA:       { base: 260, min: 0,   max: 360, mod: { source: "" } },
...
export function drawMandelbulb(ctx, w, h, p, t) {
